...
export default class Search {
    ...
    renderResultsHTML(posts) {
        if (posts.length) {
            ...
            <div class="list-group-item active"><strong>Search Results</strong> (${posts.length > 1 ? `${posts.length} items` : '1 item'})</div>
            ${posts.map(post => {
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, no results are found.</p>`
        }
        this.hideLoaderIcon()
